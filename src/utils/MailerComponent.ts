...
export const mailVerifyContent = (
  ...
  <html>
    ...
    <body>
      <div class="container">
        <h1>Halo, ${userName}</h1>
        <p>Selamat bergabung menjadi Future Hero! Sebelum menjelajahi petualangan seru bersama Flip It 2024, lengkapi proses pembuatan akun kamu dengan langkah-langkah berikut:</p>
        <br>
